...
-1. Ireland’s goal is to ensure that all Irish publicly funded research articles published from 2020 onwards will be openly available by default, to be accessible in a timely manner and on an ongoing basis.
...
3. Through this policy and related action plans, and in line with the *National Reseach Data Principles for Ireland*, we undertake to ensure that:  
...
## Preservation and re-use of scientific information(merge with infrastructure)
...
Recognise the necessity at for long term digital preservation. (infrasture
